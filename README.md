...
This project is based on the example sketch from the [M5Stack Unit Encoder library](https://github.com/ito55/M5Unit-Encoder/tree/feature/example-m5unified). It has been extended with a Serial Debug Interface to allow direct reading and writing of the encoder's I2C registers.
